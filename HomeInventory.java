...
public class HomeInventoryManger extends javax.swing.JFrame {

    /**
     * Creates new form HomeInventoryManger
     
    public HomeInventoryManger() {
        initComponents();
    }
...
/*
        try {
            ...
            java.util.logging.Logger.getLogger(HomeInventoryManger.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
*/
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeInventoryManger().setVisible(true);
            }
        });
    }
